...
#+end_src
** steamdeck-nixos
#+begin_src emacs-lisp :tangle config-steamdeck-nixos :noweb yes
  <<all>>
  <<steamdeck-nixos>>
#+end_src
...
** steamdeck-nixos
#+begin_src shell :noweb-ref steamdeck-nixos
   ### Output configuration
   #
   # Default wallpaper (more resolutions are available in /usr/share/backgrounds/sway/)
   #output * bg /usr/share/backgrounds/sway/Sway_Wallpaper_Blue_1920x1080.png fill
  ...
  output DP-1 resolution 1920x1080 scale 1.5
...
#+begin_src shell :noweb-ref steamdeck-nixos
  # Autostart
  exec waybar
  exec firefox https://twitch.tv/dennsen86
