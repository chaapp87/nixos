{
  ...
  outputs = { self, nixpkgs, nixpkgs-stable, nixpkgs-oldstable, home-manager, jovian, dotfiles, plasma-manager, ... }@inputs: 
    let
      system = "x86_64-linux";
    in
    {
             ...
             gaming-nixos = nixpkgs.lib.nixosSystem {
              ...
              modules = [
                ...
                home-manager.nixosModules.home-manager
                {
                  ...
                  home-manager.users.chaapp = import ./machines/${gaming-nixos-name}/home-chaapp.nix;
                  home-manager.backupFileExtension = "hm-backup";
                  # Optionally, use home-manager.extraSpecialArgs to pass
                  # arguments to home.nix
                  home-manager.sharedModules = [ plasma-manager.homeManagerModules.plasma-manager ];
